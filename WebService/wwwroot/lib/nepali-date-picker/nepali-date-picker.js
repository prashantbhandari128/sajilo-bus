...
!(function () {
    ...
    function d(e, t, n, r) {
        ...
        (D.innerHTML = u ? e : NepaliFunctions.ConvertToUnicode(e)),
            o.ndpMonth && o.ndpYear
                ? (p.appendChild(s(t, e, n, r)), p.appendChild(c(t, e, h, n, r)))
                : o.ndpMonth
                    ? (p.appendChild(s(t, e, n, r)), p.appendChild(y), p.appendChild(D))
                    : o.ndpYear
                        ? (p.appendChild(v), p.appendChild(y), p.appendChild(c(t, e, h, n, r)))
                        : (p.appendChild(v), p.appendChild(y), p.appendChild(D));
        var b = (function (e, t) {
            var n = e,
                r = t + 1;
